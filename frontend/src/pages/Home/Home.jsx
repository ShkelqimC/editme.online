    ...
    <section>
      ...
      <article className="p-5 mx-auto sm:p-10 md:p-16 dark:bg-gray-800 dark:text-gray-100">
        <div className="flex flex-col max-w-3xl mx-auto overflow-hidden rounded">
          <img src="/img/home-image-1.jpg" alt="editme online" className="w-full h-60 sm:h-96 dark:bg-gray-500" />
          <div className="p-6 pb-12 m-4 mx-auto -mt-16 space-y-6 lg:max-w-2xl sm:px-10 sm:mx-12 lg:rounded-md dark:bg-gray-900">
            <div className="space-y-2">
              <Link to="/getintouch" className="inline-block text-2xl font-semibold sm:text-3xl">
        ...
        <div className="dark:bg-violet-400">
          <div className="container flex flex-col items-center px-4 py-16 pb-24 mx-auto text-center lg:pb-56 md:py-32 md:px-10 lg:px-32 dark:text-gray-900">
            ...
            <div className="flex justify-center">
              <Link to="/edit" className="px-8 py-3 m-2 text-lg border rounded dark:border-gray-700 dark:text-gray-900">
                Start Using
              </Link>
            </div>
          </div>
      ...
      <article className="py-6">
        <div className="container mx-auto flex flex-col items-center justify-center max-w-lg p-4 lg:max-w-full sm:p-10 lg:flex-row">
          <div className="flex flex-col items-center justify-center flex-1 p-4 pb-8 sm:p-8 lg:p-16 ">
            ...
            <Link to="/edit" className="px-8 py-3 mt-6 text-lg font-semibold rounded sm:mt-12">No Need Sign up</Link>
          </div>
          <div className="flex flex-col items-center justify-center flex-1 p-4 pb-8 text-center rounded-md sm:p-8 lg:p-16 ">
            ...
            <Link to="/register" type="button" className="px-8 py-3 mt-6 text-lg font-semibold rounded sm:mt-12 border">
              Sign up
            </Link>
          </div>
        </div>
                  ...
                  <div className="p-6 rounded shadow-md dark:bg-gray-900">
                    ...
                    <div className="flex items-center mt-4 space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm dark:text-gray-400">Developer</p>
                      </div>
                    </div>
                  </div>
                  <div className="p-6 rounded shadow-md dark:bg-gray-900">
                    ...
                    <div className="flex items-center mt-4 space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm dark:text-gray-400">Hr</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="p-6 rounded shadow-md dark:bg-gray-900">
                    ...
                    <div className="flex items-center mt-4 space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm dark:text-gray-400">Creator</p>
                      </div>
                    </div>
                  </div>
                  <div className="p-6 rounded shadow-md dark:bg-gray-900">
                    ...
                    <div className="flex items-center mt-4 space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm dark:text-gray-400">Tester</p>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <article className="py-6 dark:bg-gray-800 dark:text-gray-50">
        <div className="container mx-auto flex flex-col items-center justify-center p-4 space-y-8 md:p-10 md:px-24 xl:px-48">
          ...
          <div className="flex flex-col space-y-4 sm:space-y-0 sm:flex-row sm:space-x-8">
            <Link to="/edit" className="px-8 py-3 text-lg font-semibold rounded dark:bg-violet-400 dark:text-gray-900">Free Editor</Link>
            <Link to="register" className="px-8 py-3 text-lg font-normal border rounded dark:bg-gray-100 dark:text-gray-900 dark:border-gray-300">
              Register
            </Link>
          </div>
        </div>
