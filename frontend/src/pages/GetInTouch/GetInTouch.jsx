...
const GetInTouch = () => {
  ...
  const form = useRef();
  // console.log(localStorage.getItem("EditMe-current-theme"))

  const onReSubmit = (value) => {
    document.getElementById("captchaForm").submit();
    console.log("Captcha value:", value);
    setIsVerified(true);
  };
  //TODO: recapcha real key when website is live
  const sendEmail = (e) => {
  ...
  return (
    <section>
        ...
        <div className="container flex flex-col-reverse mx-auto lg:flex-row items-center">
          ...
          <div className="lg:w-1/2 xl:w-3/5">
            <div className="flex items-center justify-center p-4 md:p-8 lg:p-12">
              <img src="/img/getintouch-image-1.jpg" alt="" className="rounded-lg shadow-lg sm:min-h-96" />
            </div>
          </div>
        </div>
        <hr className="border-2 w-full" />
      ...
      <article className="grid max-w-screen-xl grid-cols-1 gap-8 px-8 py-16 mx-auto rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32">
        ...
        <form className="space-y-6" onSubmit={sendEmail} ref={form} id="captchaForm">
          <div>
            <label htmlFor="name" className="text-sm">
              Full name
            </label>
            <input name="name" type="text" placeholder="" className="w-full p-3 rounded" />
          </div>
          <div>
            <label htmlFor="email" className="text-sm">
              Email
            </label>
            <input name="email" type="email" className="w-full p-3 rounded " />
          </div>
          <div>
            <label htmlFor="message" className="text-sm">
              Message
            </label>
            <textarea name="message" rows="3" className="w-full p-3 rounded "></textarea>
          </div>
          ...
          <button
            type="submit"
            disabled={isVerified === true ? true : false}
        ...
        <div className="container p-4 mx-auto space-y-16 sm:p-10">
          <div className="space-y-4">
            ...
            <p className="max-w-2xl">
              We are a team of passionate developers who strive to create innovative and user-friendly solutions. Our goal is to
              make your editing experience as seamless and enjoyable as possible.
            </p>
          </div>
          <div className="flex justify-center">
            <div className="space-y-4 mx-10">
              <img
                alt="Shenol O."
                className="object-cover h-56 mx-auto mb-4 bg-center rounded-xl"
                src="https://avatars.githubusercontent.com/u/7887878?v=4"
              />
              <div className="flex flex-col items-center">
                <h4 className="text-xl font-semibold">Shenol O.</h4>
                <p className="text-sm dark:text-gray-400">Web developer</p>
                <div className="flex mt-2 space-x-2">
                  <Link to="https://github.com/shenolosman" title="GitHub" target="_blank" rel="noreferrer">
            ...
            <div className="space-y-4 mx-10">
              <img
                alt="Shekelqim C."
                className="object-cover h-56 mx-auto mb-4 bg-center  rounded-xl"
                src="https://avatars.githubusercontent.com/u/89406677?v=4"
              />
              <div className="flex flex-col items-center">
                <h4 className="text-xl font-semibold">Shekelqim C.</h4>
                <p className="text-sm dark:text-gray-400">Web developer</p>
                <div className="flex mt-2 space-x-2">
                  <Link to="https://github.com/ShkelqimC" title="GitHub" target="_blank" rel="noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" className="w-4 h-4">
                      <path d="M16 0.396c-8.839 0-16 7.167-16 16 0 7.073 4.584 13.068 10.937 15.183 0.803 0.151 1.093-0.344 1.093-0.772 0-0.38-0.009-1.385-0.015-2.719-4.453 0.964-5.391-2.151-5.391-2.151-0.729-1.844-1.781-2.339-1.781-2.339-1.448-0.989 0.115-0.968 0.115-0.968 1.604 0.109 2.448 1.645 2.448 1.645 1.427 2.448 3.744 1.74 4.661 1.328 0.14-1.031 0.557-1.74 1.011-2.135-3.552-0.401-7.287-1.776-7.287-7.907 0-1.751 0.62-3.177 1.645-4.297-0.177-0.401-0.719-2.031 0.141-4.235 0 0 1.339-0.427 4.4 1.641 1.281-0.355 2.641-0.532 4-0.541 1.36 0.009 2.719 0.187 4 0.541 3.043-2.068 4.381-1.641 4.381-1.641 0.859 2.204 0.317 3.833 0.161 4.235 1.015 1.12 1.635 2.547 1.635 4.297 0 6.145-3.74 7.5-7.296 7.891 0.556 0.479 1.077 1.464 1.077 2.959 0 2.14-0.020 3.864-0.020 4.385 0 0.416 0.28 0.916 1.104 0.755 6.4-2.093 10.979-8.093 10.979-15.156 0-8.833-7.161-16-16-16z"></path>
                    </svg>
                  </Link>
