...
const GetInTouch = () => {
  return (
    <section>
      ...
      {/* End About Editme */}
      {/*Start Contact */}
      <article className="grid max-w-screen-xl grid-cols-1 gap-8 px-8 py-16 mx-auto rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 dark:bg-gray-800 dark:text-gray-100">
      ...
      {/*Start  About Developers */}
      <article className="dark:bg-gray-800 dark:text-gray-50 mt-20">
        <div className="container grid grid-cols-12 mx-auto">
          <div className="flex flex-col col-span-12 p-6 divide-y lg:col-span-6 lg:p-10 divide-gray-700">
            <div className="pt-6 pb-4 space-y-2">
              <span>12 June</span>
